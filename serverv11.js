// FOXHOLE REGIMENT WEBSITE v13 UI STABILIZE + RADIO CHAT
...
i+" : "+song+
"${admin ? ` <button onclick='removeSong(${i})'>REMOVE</button>` : ``}"+
"</div>";
});
...
server.listen(3000,()=>console.log("THROB RADIO UI STABLE"));