// FOXHOLE REGIMENT WEBSITE v3 FULL
// Modern Chat + Radio Chat + Navigation + UI Upgrade
...
<div id="player"></div>
<br>
<input type="range" min="0" max="100" value="50" class="slider" id="vol">
</div>

${ isAdmin ? `<div><input id="link" placeholder="youtube link"><button onclick="setRadio()">BROADCAST</button></div>` : `<p>LISTENING MODE</p>` }
