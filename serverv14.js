...
<div style="border:1px solid #66cfff;padding:15px;margin-top:25px;background:black">
<h3>RADIO STATUS</h3>
<div id="now"></div>
<div id="who"></div>
<div id="count"></div>
...
<h3 style="margin-top:30px">REGIMENT CHAT</h3>
...
state.title ? "Now Playing: "+state.title : "Radio Idle";

document.getElementById("who").innerText =
state.broadcaster ? "Broadcaster: "+state.broadcaster : "";
...
radioState.title=null;
}else{
radioState.current=next.url;
radioState.title=next.title;
radioState.startTime=Date.now();
}
io.emit("radioSync",radioState);
});
...
server.listen(3000,()=>console.log("STATUS SERVER RUNNING"));